...
import Views.EventDetails;
import javafx.scene.Scene;
import javafx.stage.Stage;

//Control the "Event Details" Window
public class EventDetailsController {
    ...
    public EventDetailsController() {
        ...
        popup = new Stage();
        eventScene = new Scene(eventDetails.getEventDetailsWindow());
        popup.setScene(eventScene);
    }

    public void assignInformation(String title, String startDate, String endDate, String startTime, String endTime, String location, String owner, String description,
                                  String guestList, String notiTime, String notiType){
        eventDetails.getInfo().get(0).setText(title);
        eventDetails.getInfo().get(1).setText(startDate);
        eventDetails.getInfo().get(2).setText(endDate);
        eventDetails.getInfo().get(3).setText(startTime);
        eventDetails.getInfo().get(4).setText(endTime);
        eventDetails.getInfo().get(5).setText(location);
        eventDetails.getInfo().get(6).setText(owner);
        eventDetails.getInfo().get(7).setText(description);
        eventDetails.getInfo().get(8).setText(guestList);
        eventDetails.getInfo().get(9).setText(notiTime);
        eventDetails.getInfo().get(10).setText(notiType);
    }
